...
const (
	...
	componentNotInstalledHint     = "See https://community.rti.com/documentation for information, or unset NDDSHOME to use rticloud-managed Connext with the required components. To start from scratch, run \"rticloud gateway reset\", then \"rticloud gateway\" again."
)
